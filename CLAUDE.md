...
- The formatters in the same file — `formatDailyTime`, `formatCountdown`, and `formatResetLabel` — are pure. Keep them that way, because they are the part of this file a test suite can cover without faking time.
